...
namespace Octopus.Client
{
    ...
    public class StartRequest : Request
    {
        ...
        {
            ConsoleReporter.Info($"@@@ StartRequest-> ProcessResponse");
        ...
        public void CheckBinom(string newBinom)
        {
            ...
            ConsoleReporter.Info($"@@@ StartRequest -> CheckBinom: {log}");
            
            ConsoleReporter.Info($"@@@ SetParam: currentBinom{currentBinom}, newBinom: {newBinom}");
